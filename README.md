...
[darkglobeinteractive/singular-theme-webpack](https://github.com/darkglobeinteractive/singular-theme)
...
mmenu is used to handle the mobile menus in this theme. [Documentation can be found here](https://mmenujs.com/)
...
GreenSock is the animation library we'd like to focus on using:<br>
